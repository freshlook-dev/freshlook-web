...
export async function POST(req: Request) {
  try {
    const body = (await req.json()) as BookingEmailPayload
    const { email, name, service, date, time, location } = body
                ...
                <table width="500" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 10px 30px rgba(0,0,0,0.05);">
                  ...
                  <tr>
                    <td style="padding:30px; color:#333;">
                      <h2 style="margin-top:0; color:#C6A96B;">Appointment Confirmed</h2>
                  ...
                  <tr>
                    <td style="padding:20px; text-align:center; font-size:12px; color:#999;">
                      Copyright Fresh Look Aesthetics
                    </td>
                  </tr>
                </table>
              </td>
