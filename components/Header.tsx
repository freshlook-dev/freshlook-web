...
export default function Header() {
  ...
  const getUser = async () => {
    ...
    if (profile) {
      ...
      setRole(profile.role || null) // ✅ ADDED
      ...
      setInitials(init || user.email?.[0]?.toUpperCase() || 'U')
    }
  }
          ...
          <div className="relative" ref={menuRef}>
            <button
              ...
              className={`w-10 h-10 rounded-full ${
                user ? 'bg-[#C6A96B] text-white' : 'bg-gray-100'
              ...
              {navLinks.map((link, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronRight
                      size={18}
                      className="text-gray-300 group-hover:text-[#C6A96B] transition"
                    />
                  </Link>
